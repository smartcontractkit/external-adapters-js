...
- [#4128](https://github.com/smartcontractkit/external-adapters-js/pull/4128) [`298d6ec`](https://github.com/smartcontractkit/external-adapters-js/commit/298d6ecdeeab31c15428f5dfce79a07c91759d05) Thanks [@karen-stepanyan](https://github.com/karen-stepanyan)! - Make rate limit tier selection required. You must now specify one of the following configuration options - RATE_LIMIT_API_TIER, RATE_LIMIT_CAPACITY, RATE_LIMIT_CAPACITY_MINUTE or RATE_LIMIT_CAPACITY_SECOND.

...
/**
 * Crucially, these are both run against a live NetDania connection, and against a mocked one.
 */
export const clientTests = () => {
  ...
  afterAll(async () => {
    console.debug('outer afterAll')
    await client.disconnect()
  })

  afterEach(() => {
    console.debug('outer afterEach')
    cb.mockClear()
  })
  ...
  describe('basic tests (actual server) (already connected)', () => {
    beforeAll(async () => {

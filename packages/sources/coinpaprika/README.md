...
![2.10.4](https://img.shields.io/github/package-json/v/smartcontractkit/external-adapters-js?filename=packages/sources/coinpaprika/package.json) ![v3](https://img.shields.io/badge/framework%20version-v3-blueviolet)
...
|    ✅     |   type   |         |       The type of the price to obtain        | string | `mark_price`, `mark_price_index`, `top_of_book`, `top_of_book_perps`, `top_of_book_spot` |         |            |                |

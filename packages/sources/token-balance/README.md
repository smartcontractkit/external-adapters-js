...
|           |   ${NETWORK}\_RPC_URL    |                                                                                     RPC url of ${NETWORK} node                                                                                     | string |         |     ``      |
|           | ${NETWORK}\_RPC_CHAIN_ID |                                                                                       Chain ID of ${NETWORK}                                                                                       | number |         |             |

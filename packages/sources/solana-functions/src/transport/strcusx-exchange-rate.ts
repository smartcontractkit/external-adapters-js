  ...
  async _handleRequest(
    ...
    return {
      data: {
        ...
        juniorComputedResult: juniorComputedRate?.toString() ?? null,
        seniorComputedResult: seniorComputedRate?.toString() ?? null,
        totalAssets: accounting.totalAssets.toString(),
        seniorAssets: accounting.seniorAssets.toString(),
        ...
        assetMintDecimals: assetMint.decimals,
        juniorMintDecimals: juniorMint.decimals,
        seniorMintDecimals: seniorMint.decimals,
        assetMintAddress: controller.assetMintAddress,
        juniorMintAddress: strategy.juniorMintAddress,
        seniorMintAddress: strategy.seniorMintAddress,
        juniorMintSupply: juniorMint.supply.toString(),
        seniorMintSupply: seniorMint.supply.toString(),
        programAddress,
        strategyName,
        controllerAddress,
        strategyAddress,
        accountingAddress,
        assetVaultAddress: strategy.assetVaultAddress,
        vestingVaultAddress: strategy.vestingVaultAddress,
        feeVaultAddress: strategy.feeVaultAddress,
        lossVaultAddress: strategy.lossVaultAddress,
        strategyStatus: strategy.status,
        strategyPaused: strategy.isPaused,
        controllerPaused: controller.isPaused,
      },
      statusCode: 200,
      result,
      timestamps: {

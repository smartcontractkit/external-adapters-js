...
const ENV_WS_CACHE_THROTTLE = 'WS_CACHE_THROTTLE'
...
const DEFAULT_WS_CACHE_THROTTLE = 1
...
export const getWSConfig = (): WSConfig => ({
  ...
  cacheThrottle: Number(getEnv(ENV_WS_CACHE_THROTTLE)) || DEFAULT_WS_CACHE_THROTTLE,
})

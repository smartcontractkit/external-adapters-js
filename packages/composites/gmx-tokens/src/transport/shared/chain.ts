  ...
  switch (chain) {
    case 'botanix':
      return {
        ...
        readerAddress: settings.BOTANIX_READER_CONTRACT_ADDRESS,
    ...
    case 'avalanche':
      return {
        ...
        readerAddress: settings.AVALANCHE_READER_CONTRACT_ADDRESS,
    ...
    case 'arbitrum':
      return {
        ...
        dataStoreAddress: settings.DATASTORE_CONTRACT_ADDRESS,
        readerAddress: settings.READER_CONTRACT_ADDRESS,
        glvReaderAddress: settings.GLV_READER_CONTRACT_ADDRESS,

...
interface NCAAFBMarketFactoryV3Interface extends ethers.utils.Interface {
  functions: {
...
export class NCAAFBMarketFactoryV3 extends Contract {
  ...
  interface: NCAAFBMarketFactoryV3Interface

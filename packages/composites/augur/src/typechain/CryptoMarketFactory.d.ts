...
interface CryptoMarketFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CryptoMarketFactory extends Contract {
  ...
  interface: CryptoMarketFactoryInterface

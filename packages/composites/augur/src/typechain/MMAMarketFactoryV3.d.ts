...
interface MMAMarketFactoryV3Interface extends ethers.utils.Interface {
  functions: {
    ...
    'createEvent(uint256,string,uint256,string,uint256,uint256,int256[2])': FunctionFragment
    ...
    'resolveEvent(uint256,uint8,uint256,uint256,uint256)': FunctionFragment
...
export class MMAMarketFactoryV3 extends Contract {
  ...
  interface: MMAMarketFactoryV3Interface
  ...
  functions: {
    ...
    'createEvent(uint256,string,uint256,string,uint256,uint256,int256[2])'(
      _eventId: BigNumberish,
      _homeTeamName: string,
      _homeTeamId: BigNumberish,
      _awayTeamName: string,
    ...
    resolveEvent(
      ...
      _homeTeamId: BigNumberish,
      _awayTeamId: BigNumberish,
      _whoWon: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> },
    ): Promise<ContractTransaction>

    'resolveEvent(uint256,uint8,uint256,uint256,uint256)'(
      _eventId: BigNumberish,
      _eventStatus: BigNumberish,
      _homeTeamId: BigNumberish,
      _awayTeamId: BigNumberish,

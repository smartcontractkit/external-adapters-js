...
export class Grouped__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): Grouped {
    return new Contract(address, _abi, signerOrProvider) as Grouped
  }
}

...
import type { AbstractMarketFactoryV3 } from '../AbstractMarketFactoryV3'

export class AbstractMarketFactoryV3__factory {
  static connect(address: string, signerOrProvider: Signer | Provider): AbstractMarketFactoryV3 {
    return new Contract(address, _abi, signerOrProvider) as AbstractMarketFactoryV3
  }
}

...
interface MLBMarketFactoryV3Interface extends ethers.utils.Interface {
  functions: {
...
export class MLBMarketFactoryV3 extends Contract {
  ...
  interface: MLBMarketFactoryV3Interface

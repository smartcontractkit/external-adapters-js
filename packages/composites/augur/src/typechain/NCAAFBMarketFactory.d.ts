...
interface NCAAFBMarketFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class NCAAFBMarketFactory extends Contract {
  ...
  interface: NCAAFBMarketFactoryInterface

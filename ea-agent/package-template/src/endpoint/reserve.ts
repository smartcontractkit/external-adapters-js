...
import { httpTransport } from '../transport/reserve-http' 
import { wsTransport } from '../transport/reserve-ws' 
import { customSubscriptionTransport } from '../transport/reserve-custombg' 
import { customTransport } from '../transport/reserve-customfg' 
...
export const endpoint = new AdapterEndpoint({
  ...
  .register('rest', httpTransport)  .register('ws', wsTransport)  .register('custombg', customSubscriptionTransport)  .register('customfg', customTransport),

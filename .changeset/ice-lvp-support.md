...
The default CACHE_MAX_AGE has been increased from 90 seconds to 300 seconds (5 minutes) to exceed the NetDania heartbeat interval, ensuring LVP functions correctly out of the box.

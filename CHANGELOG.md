...
- New adapters:
  ...
  - `blackbook` to query vehicle CPI data point
  - `marketcheck` to query vehicle CPI data point
  - `scrapinghub` to scrape multiple data points from scrapinghub.com projects
